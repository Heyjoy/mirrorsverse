...
const zh: Dict = {
    ...
    items: [
      {
        ...
        scenario: "将模型接入团队现有的 CRM、文档和工单系统，减少一线人员在多个工具间的切换。",
  ...
  services: {
    ...
    items: [
      { title: "对接现有系统", desc: "模型与你的 API、数据库、内部系统打通。长期运行，持续监控，专人维护。" },
  ...
  about: {
    ...
    tagline: "代码即承诺",
    paragraphs: [
      "镜界纪元是一家位于北京的工程公司，专注于帮助团队将模型落地到真实业务中。我们交付的是可持续运行的系统，而不是演示用的原型。",
